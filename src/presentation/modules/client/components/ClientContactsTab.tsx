...
import { Card, CardContent, CardHeader, CardTitle, Button, Input, Label, Badge, EditButton, DeleteButton } from "@/presentation/ui";
import { 
  UserPlus, 
  X, 
  Save, 
...
import { createContactSchema, type CreateContactFormData } from "@/presentation/modules/client/schemas/createContactSchema";
import { updateContactSchema, type UpdateContactFormData } from "@/presentation/modules/client/schemas/updateContactSchema";
...
export const ClientContactsTab = ({
  ...
  const handleStartEditContact = (contact: ClientContact) => {
    ...
    setEditContactValue("phoneNumber", contact.phoneNumber ? contact.phoneNumber.getValue() : "");
                ...
                <CardContent className="p-4 flex flex-col sm:flex-row justify-between gap-3">
                  <div className="space-y-1">
                    ...
                    <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
                      ...
                      {contact.phoneNumber && <span className="flex items-center gap-1.5"><Phone className="h-3.5 w-3.5" /> {contact.phoneNumber.getValue()}</span>}
                    </div>
                  </div>
