...
import { Button, Card, CardContent, CardHeader, CardTitle, CardFooter, Input, Label, PageLoader, EditButton, DeleteButton, Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DetailsHeader, ConfirmDialog } from "@/presentation/ui";
import { Loader2, Save, Cpu } from "lucide-react";
import { useTechnologiesStore } from "@/presentation/modules/technology/stores/technologies.store";
import { technologySchema, type TechnologyFormData } from "@/presentation/modules/technology/schemas/technologySchema";
